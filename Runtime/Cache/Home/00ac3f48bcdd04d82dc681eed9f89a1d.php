...
<!--             <div class="nowstate">
                <img src="/Public/Home//up_files/honor/sbadge01.png" alt=""/>
                <span>0</span>
            </div> -->
                        <div class="infostate">
                <p class="clearfix">
                    <span class="left">我的元宝:<em class="myIntegral"><?php echo ($user["points"]); ?></em></span>
                </p>
<!--                 <div class="line_bg">
                    <p class="line"></p>
                </div> -->
...
<!--             <div class="nextstate">
                <img src="/Public/Home//up_files/honor/sbadge02.png" alt=""/>
                <span>4999</span>
            </div> -->
                    </div>
        
        <ul>
            <li data-href="<?php echo U('Home/Fen/addpage');?>"><div><label class="icoWallet">在线充值</label></div></li>
        </ul>
        <ul>
            <li data-href="<?php echo U('Home/Fen/xiapage');?>"><div><label class="icoAgent">快速提现</label></div></li>
            <li data-href="<?php echo U('Home/Run/tui');?>?uid=<?php echo ($userinfo["id"]); ?>"><div><label class="icoShare">代理分享</label><span><img src="/Public/Home//statics/web/images/person_ercode_icon@2x.png" /></span></div></li>
        </ul>
        <ul>
...
//                        });
    ...
    <ul>
        ...
        <li data-href="<?php echo U('Home/run/index');?>" id="kefuUrl">客服</li>
